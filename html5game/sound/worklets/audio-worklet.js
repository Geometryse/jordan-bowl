AudioWorkletProcessor.prototype._Z1 = function () {
  ...
  this.port.onmessage = (_02) => {
    if (_02.data === "kill") this.__1 = false;
  };
};
...
class _72 extends AudioWorkletProcessor {
  ...
  process(_22, _32, parameters) {
    ...
    for (let c = 0; c < _92.length; ++c) {
      const _52 = _92[c];
      const _b2 = _a2[c];
      for (let _62 = 0; _62 < _52.length; ++_62) _b2[_62] = _52[_62];
    }
...
class _c2 extends AudioWorkletProcessor {
  ...
  process(_22, _32, parameters) {
    ...
    for (let c = 0; c < _42.length; ++c) {
      ...
      for (let _62 = 0; _62 < _52.length; ++_62) {
        _b2[_62] = _52[_62];
        if (this._h2[c] === 0) this._g2[c] = _52[_62];
        ++this._h2[c];
        this._h2[c] %= factor[_62] ?? factor[0];
        if (bypass[_62] ?? bypass[0]) continue;
        let _i2 = this._g2[c];
...
class _m2 extends AudioWorkletProcessor {
  ...
  constructor(_e2) {
    ...
    for (let c = 0; c < _f2; ++c) this.buffer[c] = new Float32Array(_o2);
  }
  process(_22, _32, parameters) {
    const _42 = _22[0];
    const _a2 = _32[0];
  ...
  _r2(_t2, _u2) {
    ...
    let _x2 = _w2 - 1;
    while (_w2 < 0) _w2 += this.buffer[_t2].length;
    while (_x2 < 0) _x2 += this.buffer[_t2].length;
    const frac = _v2 - ~~_v2;
...
class _C2 extends AudioWorkletProcessor {
  ...
  process(_22, _32, parameters) {
    ...
    if (_P2) this._Q2(cutoff[0], q[0]);
    for (let c = 0; c < _42.length; ++c) {
      const _52 = _42[c];
      const _b2 = _a2[c];
      for (let _62 = 0; _62 < _52.length; ++_62) {
        if (!_P2) this._Q2(cutoff[_62] ?? cutoff[0], q[_62] ?? q[0]);
        const _R2 =
          this._G2 * _52[_62] +
          this._H2 * this._J2[c] +
          this._I2 * this._K2[c] -
  ...
  _Q2(_S2, _T2) {
    if (_S2 === this._N2 && _T2 === this._O2) return;
...
class _83 extends AudioWorkletProcessor {
  ...
  constructor(_e2) {
    ...
    this._53(0.5);
    for (let c = 0; c < _f2; ++c)
      for (let i = 0; i < _83._a3; ++i) this._m3[c][i]._33(0.5);
  }
  process(_22, _32, parameters) {
    const _42 = _22[0];
    const _a2 = _32[0];
    ...
    for (let c = 0; c < _42.length; ++c) {
      ...
      for (let _62 = 0; _62 < _52.length; ++_62) {
        ...
        for (let i = 0; i < _83._93; ++i) out += this._l3[c][i].process(_i2);
        for (let i = 0; i < _83._a3; ++i) out = this._m3[c][i].process(out);
        if (bypass[_62] ?? bypass[0]) continue;
        const _l2 = mix[_62] ?? mix[0];
        _b2[_62] *= 1 - _l2;
        _b2[_62] += out * _l2;
  ...
  _p3(_Z2) {
    if (_Z2 === this._j3) return;
    const size = _Z2 * _83._d3 + _83._e3;
    for (let c = 0; c < this._l3.length; ++c)
      for (let i = 0; i < _83._93; ++i) this._l3[c][i]._33(size);
    this._j3 = _Z2;
  }
  _53(_63) {
    if (_63 === this._k3) return;
    const damp = _63 * _83._c3;
    for (let c = 0; c < this._l3.length; ++c)
      for (let i = 0; i < _83._93; ++i) this._l3[c][i]._53(damp);
    this._k3 = _63;
  }
}
